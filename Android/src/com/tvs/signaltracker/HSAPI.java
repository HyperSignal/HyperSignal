...
public class HSAPI {
	...
	public static void AddSignal(double latitude, double longitude, String operadora, int sinal) {
		String jsondata = "{\"metodo\":\"addsinal\",\"uid\":\"0\",\"op\":\""+operadora+"\",\"lat\":"+String.valueOf(latitude)+",\"lon\":"+String.valueOf(longitude)+",\"dev\":\""+Build.DEVICE+"\",\"man\":\""+Build.MANUFACTURER+"\",\"model\":\""+Build.MODEL+"\",\"brand\":\""+Build.BRAND+"\",\"rel\":\""+Build.VERSION.RELEASE+"\",\"and\":\""+Build.ID+"\",\"sig\":"+String.valueOf(sinal)+"}";
	...
	public static void AddTower(double latitude, double longitude, String operadora) {
		String jsondata = "{\"metodo\":\"addtorre\",\"op\":\""+operadora+"\",\"lat\":"+String.valueOf(latitude)+",\"lon\":"+String.valueOf(longitude)+"}";
		jsondata = TheUpCrypter.GenOData(jsondata);
		new CallAPI().execute(jsondata);
